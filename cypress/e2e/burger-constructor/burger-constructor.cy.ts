describe('Burger Constructor', () => {
  ...
  // cypress/e2e/burger-constructor/burger-constructor.cy.ts
  ...
  describe('Modal Windows', () => {
    it('should open and close ingredient modal by close button', () => {
      ...
      // ДОБАВЛЕНО: Проверяем, что в модалке отображаются данные именно того ингредиента, по которому кликнули
    ...
    it('should close ingredient modal by overlay click', () => {
      ...
      // Проверяем, что в модалке отображаются данные именно того ингредиента, по которому кликнули
      cy.contains('Краторная булка N-200i').should('be.visible');
